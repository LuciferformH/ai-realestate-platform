-- ============================================================
-- AI Real Estate Insights Platform - PostgreSQL Initialization
-- ============================================================
...
-- Price Predictions table (ML output)
...
CREATE INDEX idx_properties_area_sqft ON properties(area_sqft);
...
CREATE INDEX idx_properties_city_price ON properties(city_id, price);
CREATE INDEX idx_properties_type_price ON properties(property_type, price);
CREATE INDEX idx_properties_bedrooms_price ON properties(bedrooms, price);
...
CREATE INDEX idx_price_alerts_property_id ON price_alerts(property_id);
...
CREATE INDEX idx_price_predictions_property_id ON price_predictions(property_id);
CREATE INDEX idx_price_predictions_model_id ON price_predictions(model_id);
...
-- SEED DATA - Users
-- ============================================================
-- Password hashes are bcrypt hashes of the plain text passwords
-- admin123 -> $2b$12$LJ3m4ys4IhYg.5QZ5x5YNeYhPq5V7M9R5q4v2K4v1M3N5b6c7d8e
-- test123  -> $2b$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi
...
-- ============================================================
-- SEED DATA - ML Models (placeholder)
-- ============================================================
...
SELECT
    ...
    p.amenities,
    p.nearby_schools,
    p.hospital_distance_km,
    p.metro_distance_km,
    p.crime_rate,
    p.market_growth_pct,
    p.rental_yield,
    p.avg_rent_per_month,
    p.images,
    p.is_featured,
    p.is_verified,
    p.views_count,
